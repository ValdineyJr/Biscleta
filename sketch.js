...
ciclistaPrincipal.setCollider("rectangle",0,0,ciclistaPrincipal.weight/2,ciclistaPrincipal.height/2)
//definir collider para o ciclista

  
fimdeJogo = createSprite(450,150);
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Distancia: "+ distancia,700,30);
  ...
  if(keyWentDown("r")&&estadoJogo===ENCERRAMENTO){
    recomer();
  }    
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(CGRosa.isTouching(ciclistaPrincipal)){
    ...
    textSize(30)
    fill("white")
    text("Aperte 'R' para recomeçar", 275,200)
...
function ciclistaRosa(){
        ...
        CGRosa.add(jogador1);
        jogador1.setCollider("rectangle",0,0,jogador1.weight,jogador1.height)
}
...
function ciclistaAmarelo(){
        ...
        jogador2.setCollider("rectangle",0,0,jogador2.weight,jogador2.height)
}
...
function ciclistaVermelho(){
        ...
        jogador3.setCollider("rectangle",0,0,jogador3.weight,jogador3.height)
}
